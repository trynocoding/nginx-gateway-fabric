---
title: "examples/cafe-example/gateway.yaml 源码分析"
tags:
...
sources:
  - repo: nginx-gateway-fabric
    ...
    dirty: false
source_file: examples/cafe-example/gateway.yaml
source_sha256_12: 3ff372f941b1
runtime_snapshots: []
---

# examples/cafe-example/gateway.yaml 源码分析
...
**源码事实**：文件指纹为 `3ff372f941b1`，分析基于 revision `87e0580143fc`。本文没有把案例实际部署到集群，因此“生成了某条 NGINX 指令”属于源码可推导的预期，不是运行观察。
...
| 1 | `spec.listeners[0].hostname` | `*.example.com` | 声明监听端口、协议、hostname、TLS 与允许附着的 Route 范围。 |
...
1. 静态校验：`kubectl apply --dry-run=server -f examples/cafe-example/gateway.yaml`。
...
- [[cafe-example/cafe-yaml|cafe.yaml]]
- [[00-首页-学习路线]]
- [[99-源码索引与术语表]]
