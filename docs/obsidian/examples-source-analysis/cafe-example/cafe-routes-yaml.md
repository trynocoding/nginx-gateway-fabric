---
title: "examples/cafe-example/cafe-routes.yaml 源码分析"
tags:
...
sources:
  - repo: nginx-gateway-fabric
    ...
    dirty: false
source_file: examples/cafe-example/cafe-routes.yaml
source_sha256_12: 3ec855c96307
runtime_snapshots: []
---

# examples/cafe-example/cafe-routes.yaml 源码分析
...
**源码事实**：文件指纹为 `3ec855c96307`，分析基于 revision `87e0580143fc`。本文没有把案例实际部署到集群，因此“生成了某条 NGINX 指令”属于源码可推导的预期，不是运行观察。
...
1. 静态校验：`kubectl apply --dry-run=server -f examples/cafe-example/cafe-routes.yaml`。
